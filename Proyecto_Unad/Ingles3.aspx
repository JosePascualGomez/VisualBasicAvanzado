<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Ingles3.aspx.vb" Inherits="Proyecto_Unad.Ingles3" %>
...
<body style="height: 590px">
    <form id="form1" runat="server">
		...
		<div class="row">
			<div class="col-md-6 text-right"><asp:Button ID="Button1" class="btn btn-success btn-lg" runat="server" Text="Quiz" /></div>
			<div class="col-md-6 text-left"><asp:Button ID="Button2" class="btn btn-info btn-lg" runat="server" Text="Volver" /></div>
		</div>
