    ...
    <form id="form1" runat="server">
        <div class="auto-style1">
           <asp:Image ID="Image1" runat="server" Height="171px" ImageUrl="~/Imagenes/Encabezado.png" Width="748px" />
            ...
            <p>El medio ambiente o medioambiente​ es el conjunto de componentes físicos, químicos y biológicos externos con los que interactúan los seres vivos. Respecto al ser humano, comprende el conjunto de factores naturales, sociales y culturales existentes en un lugar y momento determinado, que influyen en su vida y afectarán a las generaciones futuras. Es decir, no se trata solo del espacio en el que se desarrolla la vida, sino que también comprende seres vivos, objetos, agua, suelo, aire y las relaciones entre ellos, así como elementos tan intangibles como algunas de las culturas.</p>
